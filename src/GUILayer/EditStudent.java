...
public class EditStudent extends java.awt.Dialog {
    ...
    public EditStudent(java.awt.Frame parent, boolean modal, JTable table) {
        super(parent, modal);
        initComponents();
        this.table = table;
    }
    ...
    private void JBTEditEditStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBTEditEditStudentActionPerformed
        ...
        int check1, check2, Status;
        boolean Sex;
        check1 = add.CheckStudentID(this.JTFStudentIDEditStudent.getText(), Login);
        switch (Login.type) {
            case 3:
                check2 = add.checkIfClassInDept(this.JTFClassIDEditStudent.getText(), Login.GetUserName(), Login);
            case 1:
        ...
        switch (this.Login.type) {
            case 3:
                ...
                break;
            case 1:
                DTM = show.SearchStudentButtonForEdit(this.Login.GetHostAddress(), this.Login.GetPort(), this.Login.GetDatabaseName(), this.Login.GetUserName(), this.Login.GetPassWord(), "");
                break;
        }
